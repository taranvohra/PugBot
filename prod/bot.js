      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 4:
            ...
            _context.t0 = true;
            _context.next = _context.t0 === ((0, _helpers.checkIfRoleIsPrivileged)(roles) && _constants.commands.setchannel.includes(action)) ? 16 : _context.t0 === _constants.commands.servers.includes(action) ? 23 : _context.t0 === ((0, _helpers.checkIfRoleIsPrivileged)(roles) && _constants.commands.addqueryserver.includes(action)) ? 26 : _context.t0 === ((0, _helpers.checkIfRoleIsPrivileged)(roles) && _constants.commands.delqueryserver.includes(action)) ? 33 : _context.t0 === _constants.commands.queryut99server.includes(action) ? 40 : _context.t0 === _constants.commands.addgametype.includes(action) ? 46 : _context.t0 === _constants.commands.delgametype.includes(action) ? 52 : _context.t0 === _constants.commands.joingametype.includes(action) ? 58 : _context.t0 === _constants.commands.leavegametype.includes(action) ? 66 : _context.t0 === _constants.commands.listgametype.includes(action) ? 71 : _context.t0 === _constants.commands.pickplayer.includes(action) ? 74 : _context.t0 === _constants.commands.captain.includes(action) ? 80 : 86;
            break;
